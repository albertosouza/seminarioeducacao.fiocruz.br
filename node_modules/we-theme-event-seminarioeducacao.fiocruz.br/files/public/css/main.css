...
.tags a:over:before{border-color:transparent #555 transparent transparent;}
...
body.event.findOne #region-afterContent .widget-header {
  display:none;
}
...
.widget-we-cf-video .description {
  font-size: 1.3em;
}
