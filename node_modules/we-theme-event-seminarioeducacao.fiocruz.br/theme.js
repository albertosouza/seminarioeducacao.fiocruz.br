...
module.exports = {
  ...
  layouts: {
    'default': {
      template: __dirname + '/templates/server/full-layout.hbs',
      regions: {
        highlighted: {
          name: 'Highlighted'
        },
  ...
  widgets: {
    ...
    'we-cf-menu-admin': __dirname + '/templates/server/widgets/we-cf-menu-admin.hbs',
    'we-cf-menu-content': __dirname + '/templates/server/widgets/we-cf-menu-content.hbs'
  }
};